...
(function(root, factory) {
        ...
        generatePDFJSiframe = function(targetNode, url, pdfOpenFragment, PDFJS_URL, id) {
                ...
                container.setAttribute("styles", scrollfix + "position: absolute; top: 0; right: 0; bottom: 0; left: 0;");
        ...
        generateEmbedElement = function(targetNode, targetSelector, url, pdfOpenFragment, width, height, id) {
                ...
                embed.setAttribute("class", "pdfobject");
                embed.setAttribute("src", url + pdfOpenFragment);
                embed.setAttribute("type", "application/pdf");
                embed.setAttribute("style", 'overflow: auto; ' + style);
        ...
        generateIframeElement = function(targetNode, targetSelector, url, pdfOpenFragment, width, height, id) {
                ...
                iframe.setAttribute('class', 'pdfobject');
                iframe.setAttribute('type', 'application/pdf');
                iframe.setAttribute('style', 'border: none;' + style);
                iframe.setAttribute('src', url + pdfOpenFragment);
